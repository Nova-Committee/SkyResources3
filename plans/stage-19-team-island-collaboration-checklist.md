...
- 细分角色矩阵仍留待后续权限深化阶段。
- 本地缓存身份的离线邀请和 trust 已在 Stage 71 完成；外部 profile 查询、玩家名历史解析和重命名冲突处理已在 2026-06-14 最终收口中归类为非阻塞兼容增强。
- 团队共享出生点、死亡回家点和跨维度保护留待空岛系统深化阶段。
- 旧 VIC 完整离开事件、外部 profile 查询和更细粒度访问控制已在 2026-06-14 最终收口中归类为非阻塞兼容增强；保存名离线 visit 查找已在 Stage 69 完成。
