...
final class MachineGuiTheme {
    static final int TEXT = 0xFFE8EEF5;
    static final int MUTED = 0xFF98A7B3;
    static final int GOOD = 0xFF7EE36D;
    static final int WARN = 0xFFFFB84D;
    static final int BAD = 0xFFFF6B6B;
    static final int HEAT = 0xFFFF8C2E;
    static final int ENERGY = 0xFF55D7FF;
    static final int WATER = 0xFF4C8DFF;
    static final int LIFE = 0xFFFF5F77;
    static final int MATTER = 0xFFB678FF;
    static final int PROGRESS = 0xFF45E0C2;
    static final int CATALYST = 0xFF8DE35E;
    ...
    static void renderPanel(final GuiGraphics guiGraphics, final int x, final int y, final int width, final int height) {
    ...
    static void renderSlot(final GuiGraphics guiGraphics, final int x, final int y) {
    ...
    static void renderInventoryLabel(
            final GuiGraphics guiGraphics,
            final Font font,
    ...
    static void renderHorizontalGauge(
            final GuiGraphics guiGraphics,
            final Font font,
            final Component label,
    ...
    static void renderHorizontalFill(
            final GuiGraphics guiGraphics,
            final int x,
            final int y,
            final int width,
    ...
    static void renderVerticalGauge(
            final GuiGraphics guiGraphics,
            final Font font,
            final Component label,
            final int x,
    ...
    static Component percent(final int value) {
        return Component.translatable("screen.skyresources.metric.percent", value);
    }

    static Component percent(final float ratio) {
