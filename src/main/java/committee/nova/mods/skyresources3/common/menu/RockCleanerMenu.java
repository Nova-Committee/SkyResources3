...
public final class RockCleanerMenu extends SkyResourcesMenu {
    ...
    public RockCleanerMenu(final int containerId, final Inventory playerInventory, final FriendlyByteBuf data) {
    ...
    public int getSpeed() {
        return Config.rockCleanerSpeed;
    }
