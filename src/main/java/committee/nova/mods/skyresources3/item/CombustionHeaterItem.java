...
public final class CombustionHeaterItem extends Item {
    private final MachineVariant variant;

    public CombustionHeaterItem(final Properties properties, final MachineVariant variant) {
    ...
    public void appendHoverText(
        ...
        tooltipAdder.accept(Component.translatable(
                "item.skyresources3.combustion_heater.speed",
                Math.round(this.variant.speed() * 100.0F)
        ).withStyle(ChatFormatting.BLUE));
        tooltipAdder.accept(Component.translatable(
                "item.skyresources3.combustion_heater.efficiency",
